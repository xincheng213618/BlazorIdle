...
{
    /// <summary>
    /// Enemy Attack Track Legacy 适配器 - 封装现有的怪物攻击触发逻辑
    /// Enemy Attack Track Legacy adapter - encapsulates existing enemy attack trigger logic
    /// </summary>
    public sealed class EnemyAttackTrackLegacy : ITrack
    {
        ...
        /// Constructor
        /// </summary>
        /// <param name="trackState">内部 TrackState 实例（来自 EnemyTrack.AttackTrack）</param>
        /// <param name="skillResolver">技能解析器</param>
        /// <param name="config">Track 配置</param>
        public EnemyAttackTrackLegacy(TrackState trackState, ISkillResolver skillResolver, TrackConfig config)
        {
